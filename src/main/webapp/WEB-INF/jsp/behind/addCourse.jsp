...
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal" action="${pageContext.request.contextPath}/course/saveOrUpdate" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="courseDesc" class="form-control" value="${course.courseDesc}" placeholder="课程简介">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" name="course.subjectId" rows="3">${course.subjectId}</textarea>
            </div>
        </div>
