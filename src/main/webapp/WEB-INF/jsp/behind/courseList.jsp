    ...
    <table class="table table-bordered table-hover"
        ...
        <c:forEach items="${page.rows}" var="course" varStatus="status">
            <tr>
                ...
                <td><a href="${pageContext.request.contextPath}/course/edit?=${course.subjectId}"><span
                        class="glyphicon glyphicon glyphicon-edit" aria-hidden="true"></span></a></td>
                <td><a href="#" onclick="return deleteCourseById(this,'${course.id}','${course.courseTitle}')"><span
